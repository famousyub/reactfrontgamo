...
import { deleteLead, getLeadsContent } from "./familyslice"
...
const TopSideButtons = () => {
    ...
    const openAddNewLeadModal1 = () => {
        dispatch(openModal({title : "Add New MARQUE", bodyType : MODAL_BODY_TYPES.Family_ADD_NEW}))
    }

    const openAddNewLeadModal= () => {
        dispatch(openModal({title : "Add New Lead", bodyType : MODAL_BODY_TYPES.Family_ADD_NEW}))
    }
    ...
    return(
        <div className="inline-block float-right">
            <button className="btn px-6 btn-sm normal-case btn-primary" onClick={() => openAddNewLeadModal1()}>Add family</button>
...
const TopSideButtonsSpeciality = () => {
    ...
    const openAddNewLeadModal1 = () => {
        dispatch(openModal({title : "Add New SPECIALITY", bodyType : MODAL_BODY_TYPES.MARQUE_ADD_NEW}))
    }
                                ...
                                return(
                                    ...
                                    <td>
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <div className="font-bold">{l.nomFam}</div>
                                                <div className="text-sm opacity-50">{l.idFam}</div>
                                            </div>
                                        </div>
                                    </td>
