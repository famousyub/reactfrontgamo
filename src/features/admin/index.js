...
import { deleteLead, getLeadsContent } from "./AdminSlice"
...
import AdminAddfournisseur from "../../services/AdminAddfournisseur" 

import AdminTechService from "../../services/AdminService" 
...
function Admin(){
    ...
    const openAddNewLeadModal = () => {
        dispatch(openModal({title : "Add New users", bodyType : MODAL_BODY_TYPES.LEAD_ADD_NEW}))
    }
