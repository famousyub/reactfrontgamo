...
import { deleteLead, getLeadsContent } from "./InterventionSlice"
...
const TopSideButtons = () => {
    ...
    const openAddNewLeadModal1 = () => {
        dispatch(openModal({title : "Add New intervention", bodyType : MODAL_BODY_TYPES.Intervention_ADD_NEW}))
    }
    ...
    return(
        <div className="inline-block float-right">
            <button className="btn px-6 btn-sm normal-case btn-primary" onClick={() => openAddNewLeadModal1()}>Add intervention</button>
...
function Intervention(){
    ...
    const openAddNewLeadModal = () => {
        dispatch(openModal({title : "Add New intrvention", bodyType : MODAL_BODY_TYPES.Intervention_ADD_NEW}))
    }
    ...
    useLayoutEffect(() => {
        ...
        InterventionService().then((response) => {
          if (!unmounted) {
            setBusiness(response.data);
                                    ...
                                    <td>
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-sm opacity-50">{l.statutInter}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>{l.dateInter}</td>
                                    <td> {l.descriptionIner}</td>
