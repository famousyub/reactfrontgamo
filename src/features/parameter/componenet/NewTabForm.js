import ProductCard from "./ParameterList";

import React from "react";

export default class NewItemTab extends React.Component {
    constructor() {
      super();
      this.state = {
        formErrors: {
    ...
    checkForm(){
     ...
     let data_ ; 
     localStorage.setItem("doctorname" , product  );  
      ...
      return(
        <div className='NewItemTab'>
          <div className='newItem-input'>
            ...
            <button onClick={() => this.checkForm()}>Add paramaeter</button>
          </div>
