...
import { deleteLead, getLeadsContent } from "./marqueslice"
...
const TopSideButtons = () => {
    ...
    const openAddNewLeadModal= () => {
        dispatch(openModal({title : "Add New Lead", bodyType : MODAL_BODY_TYPES.MARQUE_ADD_NEW}))
    }
    ...
    return(
        <div className="inline-block float-right">
            <button className="btn px-6 btn-sm normal-case btn-primary" onClick={() => openAddNewLeadModal1()}>Add marque</button>
                                ...
                                return(
                                    ...
                                    <td>
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <div className="font-bold">{l.nomMarque}</div>
                                                <div className="text-sm opacity-50">{l.nomMarque}</div>
                                            </div>
                                        </div>
                                    </td>
